...
class HuifuCFCA
{
    ...
    public function apiRequest(){
        ...
        $requestParam['trans_type'] = '';
        $requestParam['attach_no'] = '';
        $requestParam['attach_type'] = '';
        $requestParam['attach_desc'] = '';
        $requestParam['attach_file'] = '';
        $requestParam['file_upload_type'] = '01';


        $new_path = dirname(__FILE__)."/tincode.jpeg";
        //加签
        $cfcaSign = $this->CFCASignature($requestParam);

        $mimeContentType = "multipart/form-data";
        $name = "1.png";
        $requestParam['attach_file'] = new CURLFile($new_path,$mimeContentType,$name);
