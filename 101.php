...
class HuifuCFCA
{
    ...
    public function apiRequest(){
        ...
        $requestParam['cmd_id'] = '101';
        $requestParam['mer_cust_id'] = '';
        $requestParam['order_id'] = '';
        $requestParam['order_date'] = '';
        $requestParam['solo_flg'] = '';
        $requestParam['user_name'] = '';
        $requestParam['cert_id'] = '';
        $requestParam['user_mobile'] = '';
        $requestParam['vali_date'] = '';
        $requestParam['cust_prov'] = '0033';
        $requestParam['cust_area'] = '3305';
        $requestParam['cust_address'] = 'None';
        $requestParam['occupation'] = 'None';
        $requestParam['user_email'] = 'None';
        $requestParam['pay_password'] = '';
        $requestParam['mer_priv'] = 'None';
        $requestParam['bg_ret_url'] = 'http://192.168.0.74:8001/npayCallBack/';
